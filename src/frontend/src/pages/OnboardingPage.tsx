...
function SnapIllustration() {
  return (
    ...
    >
      ...
      />
      {/* Sparkle */}
      <circle cx="160" cy="55" r="14" fill="oklch(var(--primary)/0.15)" />
      <path
      ...
      />
      {/* Upload circle */}
      <circle cx="155" cy="140" r="16" fill="oklch(var(--primary))" />
      <path
  ...
  return (
    ...
    >
      ...
      <rect
        ...
        strokeWidth="1"
      />
      <circle cx="52" cy="86" r="7" fill="oklch(var(--primary)/0.3)" />
      <path
        d="M48 87 Q48 84 52 84 Q56 84 56 87 L56 89 L48 89 Z"
        fill="oklch(var(--primary))"
      />
      <circle cx="50" cy="89" r="1.2" fill="oklch(var(--primary))" />
      <circle cx="54" cy="89" r="1.2" fill="oklch(var(--primary))" />
      <rect
        x="64"
        y="82"
        width="30"
      ...
      <rect
        ...
        strokeWidth="1"
      />
      <circle cx="52" cy="111" r="7" fill="oklch(var(--secondary)/0.3)" />
      <rect
        x="48"
        y="107"
        width="8"
      ...
      <rect
        ...
        strokeWidth="1"
      />
      <circle cx="52" cy="136" r="7" fill="oklch(var(--accent)/0.3)" />
      <path
...
function ExportIllustration() {
  return (
    ...
    >
      ...
      />
      <rect x="49" y="34" width="6" height="2" rx="1" fill="white" />
      <rect x="57" y="34" width="4" height="2" rx="1" fill="white" />
      <rect x="63" y="34" width="6" height="2" rx="1" fill="white" />
      {/* Title + lines */}
      <rect
        x="45"
        y="54"
      ...
      {/* WhatsApp */}
      <circle cx="168" cy="130" r="18" fill="#25D366" />
      <path
      ...
      />
      {/* Email */}
      <circle cx="143" cy="162" r="15" fill="oklch(var(--primary))" />
      <rect
        x="135"
        y="156"
        width="16"
...
export default function OnboardingPage() {
  ...
  const { setOnboardingComplete, setLanguage } = useAppStore();
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 py-4 min-h-0">
        <AnimatePresence mode="wait" custom={direction}>
          ...
          >
            ...
            {/* Language selector — slide 1 only */}
            {slide.showLangSelector && (
              <motion.div
