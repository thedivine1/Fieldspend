...
class IdbKeyVal {
  ...
  static async create(options) {
    const { dbName = AUTH_DB_NAME, storeName = OBJECT_STORE_NAME, version = DB_VERSION$1 } = options ?? {};
...
const translations = {
  en: {
    ...
    "onboard.step3.desc": "Create professional expense reports in seconds and share via WhatsApp or Email.",
  ...
  hi: {
    ...
    "onboard.step3.desc": "कुछ ही सेकंड में पेशेवर खर्च रिपोर्ट बनाएं और WhatsApp या Email पर शेयर करें।",
  ...
  mr: {
    ...
    "onboard.step3.desc": "काही सेकंदात व्यावसायिक खर्च अहवाल तयार करा आणि WhatsApp किंवा Email वर शेअर करा.",
...
async function openDB() {
  if (_db) return _db;
  _db = await openDB$1(DB_NAME, DB_VERSION, {
    upgrade(db) {
...
const initialOnboarding = localStorage.getItem("sep_onboarding_complete") === "true";
...
const navItems = [
  {
    to: "/gallery",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { size: 22 }),
    labelKey: "nav.gallery",
    ocid: "nav.gallery"
  },
  {
    to: "/reports",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { size: 22 }),
...
function InstallBanner() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg leading-none mt-0.5", children: "📲" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-primary leading-snug", children: "Install on your phone" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-muted-foreground leading-snug mt-0.5", children: [
            "Open in Chrome → tap ⋮ menu → ",
...
function Layout({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-h-screen max-w-md mx-auto relative", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 bg-background pb-24 overflow-y-auto", children }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "nav",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end h-16 relative", children: [
          navItems.slice(0, 1).map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            NavLink,
            {
              item,
            ...
            Link,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: `w-14 h-14 rounded-full flex items-center justify-center shadow-md transition-smooth ${location2.pathname === "/upload" ? "bg-secondary" : "bg-primary hover:bg-primary/90"}`,
          ...
          navItems.slice(1).map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            NavLink,
            {
              item,
              isActive: location2.pathname === item.to
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground text-sm animate-pulse", children: "Loading…" }) }),
...
const indexRoute = createRoute({
  ...
  path: "/",
  beforeLoad: () => {
    const isOnboardingComplete = localStorage.getItem("sep_onboarding_complete") === "true";
...
const onboardingRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/onboarding",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(OnboardingPage, {})
});
function LayoutWrapper({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children });
}
const galleryRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/gallery",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutWrapper, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(GalleryPage, {}) })
});
const uploadRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/upload",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutWrapper, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(UploadPage, {}) })
});
const reportsRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/reports",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutWrapper, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ReportsPage, {}) })
});
const settingsRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/settings",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutWrapper, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsPage, {}) })
});
