const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jspdf.es.min-C350fUSK.js","assets/index-Qp0UCZEp.js","assets/index-DCvuN_Ot.css"])))=>i.map(i=>d[i]);
import { c as createLucideIcon, _ as __vitePreload, t, R as React, a as useAppStore, r as reactExports, j as jsxRuntimeExports, b as Link, F as FileText, d as ue } from "./index-Qp0UCZEp.js";
import { B as Button, j as Badge } from "./index-B0G-Jbi4.js";
import { S as Select, b as SelectTrigger, c as SelectValue, d as SelectContent, e as SelectItem } from "./select-BX4urHRz.js";
import { S as ShieldCheck, a as Separator, M as Mail } from "./separator-DRlOiMSe.js";
import { h as hasPremiumAccess, S as Sparkles, C as CircleCheck } from "./premium-C3zV1u21.js";
...
async function generateExpenseReport(profile, receipts, month, year, isFreeUser) {
  const { jsPDF } = await __vitePreload(async () => {
    const { jsPDF: jsPDF2 } = await import("./jspdf.es.min-C350fUSK.js").then((n) => n.j);
    return { jsPDF: jsPDF2 };
  }, true ? __vite__mapDeps([0,1,2]) : void 0);
  const doc = new jsPDF({ orientation: "portrait", unit: "mm", format: "a4" });
  const pageWidth = doc.internal.pageSize.getWidth();
  const monthName = MONTH_NAMES$1[month - 1];
  ...
  for (let i = 1; i <= totalPages; i++) {
    ...
    doc.setFont("helvetica", "normal");
    doc.text(
      `SalesExpense Pro — Generated ${(/* @__PURE__ */ new Date()).toLocaleDateString("en-IN")}`,
      15,
      pageH - 3.5
    );
...
function buildEmailBody(breakdown, grandTotal, monthName, year) {
  const lines = breakdown.map(
    (item) => `${t(`cat.${item.category}`)}: ${formatCurrency(item.total)} (${item.count} ${item.count === 1 ? "item" : "items"})`
  );
...
function ReportsPage() {
  ...
  async function handleGenerate() {
    if (!userProfile) {
      ue.error("Please set up your profile first — go to Settings");
      return;
    }
    if (filteredReceipts.length === 0) {
      ue.error("No receipts for this month");
      return;
    }
...
(PDF attached separately)`
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-5 space-y-5 pb-8", "data-ocid": "reports.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-xl text-foreground", children: t("report.title") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "खर्च अहवाल" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2.5", "data-ocid": "reports.period_selector", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: String(selectedMonth), onValueChange: handleMonthChange, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          SelectTrigger,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: MONTH_NAMES.map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectItem, { value: String(i + 1), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: m }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 text-muted-foreground text-xs", children: MONTH_NAMES_HI[i] })
        ] }, m)) })
      ] }),
    ...
    isFreeUser && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-medium text-amber-700 dark:text-amber-400", children: [
              "Your PDF will include a ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: '"Free Version"' }),
              " watermark."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-amber-600 dark:text-amber-500 mt-0.5", children: "Upgrade to Premium for clean, watermark-free reports." })
          ] }),
    ...
    isPremium && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-secondary", children: "Clean PDF — no watermark" })
        ]
      }
    ),
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-destructive flex-1", children: [
            "Set your name in",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/settings", className: "underline font-semibold", children: "Settings" }),
            " ",
      ...
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-br from-primary/15 via-secondary/10 to-transparent border-b border-border px-5 py-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shrink-0 text-right", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-primary uppercase tracking-wide", children: "Expense Report" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: reportTitle })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-0.5", children: t("report.total") }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2", children: "Category Breakdown · श्रेणी सारांश" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-2 pb-1", children: [
              ...
              filteredReceipts.length,
              " ",
              filteredReceipts.length === 1 ? "image" : "images",
              " attached"
            ] })
          ] })
        ]
      ...
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground mb-5", children: [
            monthName,
            " महीने की कोई रसीद नहीं — पहले रसीद जोड़ें"
          ] }),
    ...
    !hasNoReceipts && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          isFreeUser && !isGenerating && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-center text-muted-foreground mt-2", children: "Watermark will be added · मुफ़्त संस्करण वॉटरमार्क" })
        ]
      }
    ),
    pdfReady && pdfBlob && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider text-center", children: "Share Report · रिपोर्ट शेयर करें" }),
              ...
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left min-w-0", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate", children: "Send link" })
                  ] })
                ]
              }
            ),
              ...
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left min-w-0", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate", children: "Send report" })
                  ] })
                ]
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center px-2", children: "💡 PDF is already downloaded. Attach it manually in WhatsApp." })
        ]
      }
    )
  ] });
